...
3. **CONSULT SPECIALISTS** - For hard/complex tasks, DO NOT struggle alone. Delegate:
   - **Architect**: Conventional problems - architecture, debugging, complex logic
...
task(subagent_type="architect", load_skills=[], prompt="Review my approach: [describe plan]", run_in_background=false)
\`\`\`
...
3. **DO** consult specialists (architect for conventional, artistry for non-conventional)
...
| Hard problem (conventional) | task(subagent_type="architect") | Architecture, debugging, complex logic |
