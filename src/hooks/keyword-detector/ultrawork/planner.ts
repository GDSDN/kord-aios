/**
 * Ultrawork message section for planner agents (Plan).
...
|------|---------|---------|
| Write/Edit | docs/kord/**/*.md ONLY | Everything else |
| Read | All files | - |
| Bash | Research commands only | Implementation commands |
| task | explore, librarian | - |

**IF YOU TRY TO WRITE/EDIT OUTSIDE docs/kord/:**
- System will BLOCK your action
- You will receive an error
- DO NOT retry - you are not supposed to implement

**YOUR ONLY WRITABLE PATHS:**
- docs/kord/plans/*.md - Final work plans
- docs/kord/drafts/*.md - Working drafts during interview
...
- Orchestrator (Kord) executes tasks in parallel waves
