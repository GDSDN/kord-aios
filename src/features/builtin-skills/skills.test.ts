...
describe("createBuiltinSkills", () => {
	test("returns playwright skill by default", () => {
		...
		// when
		const skills = createBuiltinSkills({ includeKordAiosSkills: false })
	...
	test("returns playwright skill when browserProvider is 'playwright'", () => {
		...
		// when
		const skills = createBuiltinSkills({ ...options, includeKordAiosSkills: false })
	...
	test("always includes frontend-ui-ux and git-master skills", () => {
		...
		// when
		const defaultSkills = createBuiltinSkills({ includeKordAiosSkills: false })
		const agentBrowserSkills = createBuiltinSkills({ browserProvider: "agent-browser", includeKordAiosSkills: false })
