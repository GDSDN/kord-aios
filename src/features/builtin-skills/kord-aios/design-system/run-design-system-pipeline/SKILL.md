...
description: "Run Design System Pipeline methodology and workflow"
subtask: false
---
...
jobs:
  quality-pipeline:
    ...
    steps:
      ...
      - name: Run Design System Pipeline
        run: npx kord-aios-core task run-design-system-pipeline --mode=yolo
```
...
{
  "scripts": {
    "ds:pipeline": "npx kord-aios-core task run-design-system-pipeline",
    "ds:pipeline:ci": "npx kord-aios-core task run-design-system-pipeline --mode=yolo"
  }
}
```
