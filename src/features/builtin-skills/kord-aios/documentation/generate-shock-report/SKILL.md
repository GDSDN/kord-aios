---
name: generate-shock-report
description: "Generate Visual Shock Report methodology and workflow"
agent: dev
subtask: false
---
...
10. *Generate Report File**
     - Save as `docs/kord/drafts/shock-report.html`
...
12. *Record Notes (Optional)**
    - Write a short summary note to `docs/kord/notepads/shock-report.md`
    - Include: scope, how examples were selected, and next steps

## Output

- `docs/kord/drafts/shock-report.html`: Self-contained visual report
- *shock-report.pdf**: PDF version (optional)
- `docs/kord/notepads/shock-report.md`: Notes (optional)
...
<body>
  <header>
    ...
    <p class="subtitle">Generated by Kord AIOS</p>
  </header>
