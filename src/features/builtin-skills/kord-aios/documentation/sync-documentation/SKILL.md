...
description: "sync-documentation methodology and workflow"
agent: dev
subtask: false
---
...
sync-documentation --component kord-aios-core/scripts/pattern-learner.js
...
class SyncDocumentationTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('📚 Kord AIOS Documentation Synchronization'));
