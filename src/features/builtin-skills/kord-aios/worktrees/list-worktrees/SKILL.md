---
name: list-worktrees
description: "list-worktrees methodology and workflow"
agent: devops
subtask: false
---
...
Lists all Kord AIOS-managed worktrees with their current status, uncommitted changes, and age. Provides visibility into parallel development activities.

*Features:**

- Shows all active worktrees managed by Kord AIOS
...
*Action:** Get all Kord AIOS-managed worktrees
...
[
  {
    "storyId": "STORY-42",
    "path": "/abs/path/.kord-aios/worktrees/STORY-42",
...
No Kord AIOS-managed worktrees found.
...
```
❌ WorktreeManager not found.
   Ensure Kord AIOS is properly installed.
```

*Resolution:** Check Kord AIOS installation.
