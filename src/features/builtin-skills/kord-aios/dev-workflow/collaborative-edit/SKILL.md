...
description: "collaborative-edit methodology and workflow"
agent: dev
subtask: false
---
...
collaborative-edit start --component kord-aios-core/agents/data-agent.md --participants alice,bob --mode live
...
class CollaborativeEditTask extends EventEmitter {
  constructor() {
    ...
    this.sessionDir = path.join(this.rootPath, '.kord-aios', 'sessions');
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('👥 Kord AIOS Collaborative Editing'));
