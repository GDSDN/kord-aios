---
name: dev-improve-code-quality
description: "No checklists needed - this task performs automated code refactoring, validation is through linting and testing methodology and workflow"
agent: dev
subtask: false
---
...
improve-code-quality kord-aios-core/scripts/legacy-utility.js --preview

# Auto-fix all safe improvements in directory
improve-code-quality kord-aios-core/agents --auto-fix --recursive

# Apply specific patterns
improve-code-quality kord-aios-core/utils --patterns formatting,modern-syntax,async-await

# Generate improvement report
improve-code-quality . --recursive --report quality-report.json

# Use custom configuration
improve-code-quality kord-aios-core --config .kord-aios/quality-config.json
```
...
class ImproveCodeQualityTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🎨 Kord AIOS Code Quality Improvement'));
  ...
  async createBackup(filePath) {
    const backupDir = path.join(this.rootPath, '.kord-aios', 'backups', 'code-quality');
