---
name: gotchas
description: "List Gotchas methodology and workflow"
agent: dev
subtask: false
---
...
steps:
  - name: Load Gotchas
    action: |
      Load gotchas from .kord-aios/gotchas.json via GotchasMemory
...
- *Script:** `gotchas-memory.js`
- *Source:** `.kord-aios/gotchas.json`
