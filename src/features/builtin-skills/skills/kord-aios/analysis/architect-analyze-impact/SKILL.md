---
name: architect-analyze-impact
description: "An methodology and workflow"
agent: architect
subtask: false
---
...
Analyze the potential impact of proposed component modifications on the broader Kord AIOS Kord AIOS framework.
...
analyze-impact modify kord-aios-core/agents/weather-agent.md --depth deep --include-tests

# Analyze deprecation impact with visual output
analyze-impact deprecate kord-aios-core/scripts/old-helper.js --output-format visual --save-report reports/deprecation-impact.html

# Quick impact check for refactoring
analyze-impact refactor kord-aios-core/tasks/process-data.md --depth shallow --risk-threshold medium

# Analyze removal with approval workflow
analyze-impact remove kord-aios-core/workflows/legacy-workflow.yaml --depth deep --save-report reports/removal-impact.json
```
...
class AnalyzeImpactTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🔍 Kord AIOS Impact Analysis'));
...
{
  "success": true,
  "targetComponent": "kord-aios-core/agents/weather-agent.md",
  "riskLevel": "medium",
