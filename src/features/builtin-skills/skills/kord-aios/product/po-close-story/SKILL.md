---
name: po-close-story
description: "PO Task: Close Story methodology and workflow"
agent: po
subtask: false
---
...
questions:
  - Story path (relative to docs/stories/):
    ...
    example: "epics/epic-pro-kord-aios-pro-architecture/story-pro-5-repo-bootstrap.md"
...
close-story epics/epic-pro-kord-aios-pro-architecture/story-pro-5-repo-bootstrap.md
