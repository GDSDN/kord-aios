...
description: "Catch and auto-fix code quality issues before marking story as \"Ready for Review\""
agent: dev
subtask: false
---
...
Catch and auto-fix code quality issues before marking story as "Ready for Review"
...
7. Execute `story-dod-checklist.md`
...
│    │    wsl bash -c 'cd /mnt/c/.../@kord-aios/kord-aios-core &&    │   │
...
- `story-dod-checklist.md` - Definition of Done checklist
