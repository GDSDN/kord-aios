...
description: "Manage Software Releases methodology and workflow"
agent: devops
subtask: false
---
...
- *published_packages**: `array<object>`
  ...
  - *Example**: `[{ registry: "npm", package_name: "kord-aios-core", version: "2.1.3", url: "https://npmjs.com/package/kord-aios-core" }]`
...
kord-aios release create --repo="." --type="auto"
````
