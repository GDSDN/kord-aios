---
name: qa-create-fix-request
description: "Create Fix Request Task methodology and workflow"
agent: qa
subtask: false
---
...
_Generated by Quinn (Test Architect) - Kord AIOS QA System_
