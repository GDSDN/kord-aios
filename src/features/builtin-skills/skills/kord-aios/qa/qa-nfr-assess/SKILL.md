---
name: qa-nfr-assess
description: "nfr-assess methodology and workflow"
agent: qa
subtask: false
---
...
required:
  ...
  - story_path: `kord-aios-core/core-config.yaml` for the `devStoryLocation`

optional:
  - architecture_refs: `kord-aios-core/core-config.yaml` for the `architecture.architectureFile`
  - technical_preferences: `kord-aios-core/core-config.yaml` for the `technicalPreferences`
