...
- Identify and load the following inputs:
  ...
  - *Story template**: `kord-aios-core/templates/story-tmpl.yaml` for completeness validation

### 1. Template Completeness Validation

- Load `kord-aios-core/templates/story-tmpl.yaml` and extract all section headings from the template
...
*PRD Reference:** Kord AIOS v2.0 "Projeto Bob" - Section 5 (Dynamic Executor Assignment)
