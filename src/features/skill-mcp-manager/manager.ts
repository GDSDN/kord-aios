...
type OAuthProvider = {
  ...
  login: () => Promise<{ accessToken: string; refreshToken?: string; expiresAt?: number }>
}

export type SkillMcpManagerDeps = {
...
export class SkillMcpManager {
  ...
  private authProviders: Map<string, OAuthProvider> = new Map()
  ...
  private readonly createOAuthProvider: NonNullable<SkillMcpManagerDeps["createOAuthProvider"]>

  constructor(deps: SkillMcpManagerDeps = {}) {
    this.createOAuthProvider = deps.createOAuthProvider ?? ((o) => new McpOAuthProvider(o))
  }

  /**
   * Get or create an OAuth provider for a given server URL + oauth config.
