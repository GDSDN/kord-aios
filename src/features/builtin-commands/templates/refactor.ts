...
Fire ALL of these simultaneously using \`call_kord_agent\`:
...
4. **OPTIONS**:
   ...
   - Consult architect agent for help
...
- \`architect\`: Read-only consultation for complex architectural decisions and debugging
