...
21 feature modules: background agents, skill MCPs, builtin skills/commands, Claude Code compatibility layer, task management.
...
|------|--------------------------|
| Commands | `.opencode/commands/` > `~/.config/opencode/commands/` > `.claude/commands/` |
