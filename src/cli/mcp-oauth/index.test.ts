...
describe("mcp oauth command", () => {
  describe("command structure", () => {
    it("creates mcp command group with oauth, detect, and status subcommands", () => {
      // given
  ...
  describe("detect/status root subcommands", () => {
    it("detect subcommand accepts --json option", () => {
      // given
      const mcpCommand = createMcpOAuthCommand();
      const detectCommand = mcpCommand.commands.find(
        (cmd: Command) => cmd.name() === "detect",
      );

      // when
      const options = detectCommand?.options ?? [];
      const jsonOption = options.find(
        (opt: { long?: string }) => opt.long === "--json",
      );
    ...
    it("status subcommand accepts --json option", () => {
      // given
      const mcpCommand = createMcpOAuthCommand();
      const statusCommand = mcpCommand.commands.find(
        (cmd: Command) => cmd.name() === "status",
      );
