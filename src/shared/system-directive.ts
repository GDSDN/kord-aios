/**
 * Unified system directive prefix for Kord AIOS internal messages.
 * All system-generated messages should use this prefix for consistent filtering.
 *
 * Format: [SYSTEM DIRECTIVE: KORD_AIOS - {TYPE}]
 */

export const SYSTEM_DIRECTIVE_PREFIX = "[SYSTEM DIRECTIVE: KORD_AIOS"

/**
 * Creates a system directive header with the given type.
 * @param type - The directive type (e.g., "TODO CONTINUATION", "RALPH LOOP")
 * @returns Formatted directive string like "[SYSTEM DIRECTIVE: KORD_AIOS - TODO CONTINUATION]"
 */
...
/**
 * Checks if a message starts with the Kord AIOS system directive prefix.
