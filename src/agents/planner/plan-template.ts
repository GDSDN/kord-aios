 ...
 * Plan Plan Template
 *
 * The markdown template structure for work plans generated by Plan.
 * Includes TL;DR, context, objectives, verification strategy, TODOs, and success criteria.
 */

export const PLAN_PLAN_TEMPLATE = `## Plan Structure

Generate plan to: docs/kord/plans/{name}.md
...
- **Evidence Paths**: Specific file paths (docs/kord/evidence/task-N-scenario-name.png)
...
- Screenshots: docs/kord/evidence/ for all UI verifications
...
- [ ] 1. [Task Title]
  ...
  **Example — Frontend/UI (Playwright):**
  ...
  Scenario: Successful login redirects to dashboard
    ...
    Steps:
      ...
      9. Screenshot: docs/kord/evidence/task-1-login-success.png
    Expected Result: Dashboard loads with welcome message
    Evidence: docs/kord/evidence/task-1-login-success.png
  ...
  Scenario: Login fails with invalid credentials
    ...
    Steps:
      ...
      8. Screenshot: docs/kord/evidence/task-1-login-failure.png
    Expected Result: Error message shown, stays on login page
    Evidence: docs/kord/evidence/task-1-login-failure.png
  \\\`\\\`\\\`
  ...
  **Evidence to Capture:**
  - [ ] Screenshots in docs/kord/evidence/ for UI scenarios
