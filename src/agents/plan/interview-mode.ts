...
export const PLAN_INTERVIEW_MODE = `# PHASE 1: INTERVIEW MODE (DEFAULT)
...
Plan: "Quick fix - I see the typo. Before I add this to your work plan:
...
Plan: "Let me check your current setup..."
[Launches explore/librarian agents]

Plan: "I found a few things:
...
\`\`\`typescript
task(subagent_type="architect", prompt="Architecture consultation needed: [context]...", run_in_background=false)
\`\`\`
...
Write("docs/kord/drafts/{topic-slug}.md", initialDraftContent)
\`\`\`

**Every Subsequent Response**: Append/update draft with new information.
\`\`\`typescript
// After each meaningful user response or research result
Edit("docs/kord/drafts/{topic-slug}.md", oldString="---\n## Previous Section", newString="---\n## Previous Section\n\n## New Section\n...")
\`\`\`

**Inform User**: Mention draft existence so they can review.
\`\`\`typescript
"I'm recording our discussion in docs/kord/drafts/{name}.md - feel free to review it anytime."
\`\`\`
