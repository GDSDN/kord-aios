...
todoWrite([
  ...
  { id: "plan-2", content: "Generate work plan to docs/kord/plans/{name}.md", status: "pending", priority: "high" },
  { id: "plan-3", content: "Self-review: classify gaps (critical/minor/ambiguous)", status: "pending", priority: "high" },
  { id: "plan-4", content: "Present summary with auto-resolved items and decisions needed", status: "pending", priority: "high" },
  { id: "plan-5", content: "If decisions needed: wait for user, update plan", status: "pending", priority: "high" },
  { id: "plan-6", content: "Ask user about high accuracy mode (QA review)", status: "pending", priority: "high" },
  { id: "plan-7", content: "If high accuracy: Submit to QA and iterate until OKAY", status: "pending", priority: "medium" },
...
2. Mark plan-1 as \`in_progress\` → Consult Plan Analyzer (auto-proceed, no questions)
...
**BEFORE generating the plan**, summon Plan Analyzer to catch what you might have missed:
...
## Post-Plan-Analyzer: Auto-Generate Plan and Summarize
...
2. **Generate the work plan immediately** to docs/kord/plans/{name}.md
  ...
  questions: [{
    ...
    options: [
      ...
      },
      {
        ...
        description: "Have QA rigorously verify every detail. Adds review loop but guarantees precision."
      }
    ]
  }]
})
...
- **High Accuracy Review** → Enter QA loop (PHASE 3)
