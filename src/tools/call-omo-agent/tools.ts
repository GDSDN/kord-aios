  ...
  return tool({
    ...
    args: {
      ...
      subagent_type: tool.schema
        .string()
        .describe(
          "The type of specialized agent to use for this task (story specialists and exploration agents)",
        ),
    ...
    async execute(args: CallOmoAgentArgs, toolContext) {
      ...
      const normalizedAgent =
        args.subagent_type.toLowerCase() as (typeof ALLOWED_AGENTS)[number];
