...
- category: Use predefined category → Spawns Dev with category config
  ...
  return tool({
    ...
    async execute(args: DelegateTaskArgs, toolContext) {
      ...
      if (args.category && !args.subagent_type) {
        args.subagent_type = DEV_AGENT;
      }
      args.subagent_type = normalizeDevAgentName(args.subagent_type);
      await ctx.metadata?.({
