...
export const AgentFallbackSlotSchema = z.object({
...
export const AgentOverrideConfigSchema = z.object({
  ...
  variant: z.string().optional(),
  /** Static fallback chain for this agent (first available slot is selected). */
  fallback: z.array(AgentFallbackSlotSchema).max(4).optional(),
...
export const AgentOverridesSchema = z.object({
  ...
  kord: AgentOverrideConfigSchema.optional(),
  planner: AgentOverrideConfigSchema.optional(),
  // Legacy alias for backward compatibility
  build: AgentOverrideConfigSchema.optional(),
  dev: AgentOverrideConfigSchema.optional(),
  "dev-junior": AgentOverrideConfigSchema.optional(),
  "OpenCode-Builder": AgentOverrideConfigSchema.optional(),
  analyst: AgentOverrideConfigSchema.optional(),
  "plan-analyzer": AgentOverrideConfigSchema.optional(),
  "plan-reviewer": AgentOverrideConfigSchema.optional(),
  qa: AgentOverrideConfigSchema.optional(),
  architect: AgentOverrideConfigSchema.optional(),
  librarian: AgentOverrideConfigSchema.optional(),
  explore: AgentOverrideConfigSchema.optional(),
  vision: AgentOverrideConfigSchema.optional(),
  sm: AgentOverrideConfigSchema.optional(),
  pm: AgentOverrideConfigSchema.optional(),
  po: AgentOverrideConfigSchema.optional(),
  devops: AgentOverrideConfigSchema.optional(),
  "data-engineer": AgentOverrideConfigSchema.optional(),
  "ux-design-expert": AgentOverrideConfigSchema.optional(),
  "squad-creator": AgentOverrideConfigSchema.optional(),
})
...
export const KordAgentConfigSchema = z.object({
...
export const CategoryConfigSchema = z.object({
  ...
  /** Per-category routing mode: static (default) or dynamic */
  routing_mode: RoutingModeSchema.optional(),
  /** Custom fallback model slots for this category (max 4, overrides CATEGORY_MODEL_REQUIREMENTS) */
...
export const GitMasterConfigSchema = z.object({
  /** Add "Ultraworked with Kord" footer to commit messages (default: true) */
  commit_footer: z.boolean().default(true),
  /** Add "Co-authored-by: Kord" trailer to commit messages (default: true) */
...
export const WaveCheckpointConfigSchema = z.object({
  /** Checkpoint mode: auto skips checkpoints, interactive pauses for @po review */
  mode: z.enum(["auto", "interactive"]).optional(),
})

export const ExecutorResolverConfigSchema = z.object({
  /** Custom executor→skill mapping overrides. Merges with defaults. */
  skill_mapping: z.record(z.string(), z.array(z.string())).optional(),
})

export const SquadConfigSchema = z.object({
  /** Default squad to load on /start-work if no --squad flag */
  default_squad: z.string().optional(),
  /** Additional search paths for SQUAD.yaml manifests */
...
export const KordConfigSchema = z.object({
  tasks: KordTasksConfigSchema.optional(),
})
export const OhMyOpenCodeConfigSchema = z.object({
  $schema: z.string().optional(),
  /** Enable new task system (default: false) */
  new_task_system_enabled: z.boolean().optional(),
  /** Default agent name for `kord-aios run` (env: OPENCODE_DEFAULT_AGENT) */
  ...
  kord_agent: KordAgentConfigSchema.optional(),
  ...
  story_lifecycle: z.object({
    allow_force_override: z.boolean().optional(),
  }).optional(),
  quality_gate: z.object({
    max_iterations: z.number().int().positive().optional(),
  }).optional(),
  decision_logger: z.object({
    directory: z.string().optional(),
  }).optional(),
  wave_checkpoint: WaveCheckpointConfigSchema.optional(),
  executor_resolver: ExecutorResolverConfigSchema.optional(),
...
export type KordAgentConfig = z.infer<typeof KordAgentConfigSchema>
...
export type KordTasksConfig = z.infer<typeof KordTasksConfigSchema>
export type KordConfig = z.infer<typeof KordConfigSchema>
