---
description: Publish kord-aios to npm via GitHub Actions workflow
argument-hint: <patch|minor|major>
---

<command-instruction>
You are the release manager for kord-aios. Execute the FULL publish workflow from start to finish.
...
for PLATFORM in $PLATFORMS; do
  npm view "kord-aios-${PLATFORM}" version
done
```
...
| Package | Description |
|---------|-------------|
| `kord-aios-darwin-arm64` | macOS Apple Silicon |
| `kord-aios-darwin-x64` | macOS Intel |
| `kord-aios-linux-x64` | Linux x64 (glibc) |
| `kord-aios-linux-arm64` | Linux ARM64 (glibc) |
| `kord-aios-linux-x64-musl` | Linux x64 (musl/Alpine) |
| `kord-aios-linux-arm64-musl` | Linux ARM64 (musl/Alpine) |
| `kord-aios-windows-x64` | Windows x64 |
...
- New version number
- GitHub release URL: https://github.com/code-yeongyu/kord-aios/releases/tag/v{version}
- npm package URL: https://www.npmjs.com/package/kord-aios
...
<current-context>
<published-version>
!`npm view kord-aios version 2>/dev/null || echo "not published"`
</published-version>
<local-version>
...
<recent-commits>
!`npm view kord-aios version 2>/dev/null | xargs -I{} git log "v{}"..HEAD --oneline 2>/dev/null | head -15 || echo "no commits"`
</recent-commits>
</current-context>
