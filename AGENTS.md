...
Kord AIOS is a **plugin for OpenCode**. You will frequently need to examine OpenCode's source code to:
...
kord-aios/
├── src/
│   ├── agents/           # 20+ AI agents - see src/agents/AGENTS.md
│   ├── hooks/            # 40+ lifecycle hooks - see src/hooks/AGENTS.md
│   ├── tools/            # 25+ tools - see src/tools/AGENTS.md
│   ├── features/         # Background agents, skills, squads, Claude Code compat - see src/features/AGENTS.md
...
| `src/hooks/build/index.ts` | 913 | Orchestrator hook |
...
| `src/agents/kord.ts` | 613 | Main orchestrator agent |
