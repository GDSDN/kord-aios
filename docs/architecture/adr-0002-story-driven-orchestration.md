...
- Drift from Kord AIOS's fast loop philosophy

**Core Tension:**

- AIOS requires artifact integrity (story-driven methodology)
- Kord AIOS optimizes for velocity (fast execution loops)
...
| Principle                    | Rationale                                                     |
| ---------------------------- | ------------------------------------------------------------- |
| **Minimal Blockers**         | Keep the Kord AIOS loop fast; don't gate execution on bureaucracy  |
...
## 8. Preserving Kord AIOS Loop Speed
...
**Never use**: legacy notepad directories for story-driven work (use story file instead)
...
6. **Preserve Kord AIOS velocity** - Don't let process block productive work
7. **Maintain traceability** - All decisions are attributable and reversible
