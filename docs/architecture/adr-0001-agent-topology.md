...
| Kord AIOS Agent | Purpose                                                          | Mode    | Model Tier |
| --------------- | ---------------------------------------------------------------- | ------- | ---------- |
...
| OMOC (Legacy)   | AIOS (Framework) | Kord AIOS (Canonical) | Type     | Notes                                 |
| --------------- | ---------------- | --------------------- | -------- | ------------------------------------- |
...
- Kord AIOS names are **user-facing** - what users type to invoke agents
...
| OMOC Name       | Canonical Kord AIOS | Actual Role                       | Key Evidence                                     |
| --------------- | ------------------- | --------------------------------- | ------------------------------------------------ |
...
| Kord AIOS       | AIOS Reference | OMOC Alias  | Purpose                                         | Mode    | Model Tier |
| --------------- | -------------- | ----------- | ----------------------------------------------- | ------- | ---------- |
...
### Complete Mapping Table (OMOC | AIOS | Kord AIOS)
...
const agentSources: Record<string, AgentSource> = {
  // Canonical Kord AIOS names (user-facing)
...
Legacy OMOC names continue working indefinitely without warnings. Deprecation warnings may be added in Phase 2 (post-stabilization) if desired. Use Kord AIOS canonical names in all new documentation and code.
...
```bash
# YOLO as a flag
kord-aios build --yolo          # Skip confirmations
kord-aios build -y              # Short form
