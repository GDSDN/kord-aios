...
- **OMOC Engine** (kord-aios): A battle-tested Bun-based runtime with 40+ hooks, 25+ tools, and sophisticated agent management
...
│   ├── kord-aios.js                  # Legacy CLI (kept for compat)
│   ├── kord-aios.js                       # New CLI entry
│   └── platform.js                        # Platform detection
│
├── docs/                                  # PROJECT DOCUMENTATION
│   ├── architecture/                      # Architecture docs
│   │   ├── kord-aios-architecture.md      # This document
│   │   └── ...
│   ├── migration/                         # Migration documentation
│   │   ├── kord-aios-migration-plan.md
│   │   ├── kord-aios-task-board.md
...
### 4.2 Agent Mapping (OMOC → Kord AIOS)

**Source of Truth: `src/agents/AGENTS.md`**

| OMOC Name           | Kord AIOS Name      | Compatibility Alias | Role (from AGENTS.md)                     |
| ------------------- | ------------------- | ------------------- | ----------------------------------------- |
...
**Net-New Kord AIOS Agents (no OMOC predecessor):**
| Kord AIOS Name | Role |
| -------------- | ---------------------------- |
...
npm install --save-dev @synkra/kord-aios
```
...
See `docs/migration/kord-aios-migration-plan.md` for detailed migration steps.
...
| `docs/migration/kord-aios-migration-plan.md` | Migration details    |

### B. External References

- [OMOC Documentation](https://github.com/kord-aios/kord-aios)
