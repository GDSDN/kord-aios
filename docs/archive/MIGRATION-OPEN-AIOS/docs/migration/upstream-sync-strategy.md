# Upstream Sync Strategy (kord-aios)

## Remotes
- `upstream`: `https://github.com/code-yeongyu/kord-aios.git` (OMOC source)
- `origin`: your `kord-aios` fork repository (set this after creating GitHub repo)
