...
| Type         | Open-AIOS   | AIOS Ref   | OMOC Alias  | Purpose                           |
| ------------ | ----------- | ---------- | ----------- | --------------------------------- |
...
- Canonical mapping (OMOC → AIOS → Open-AIOS):
...
- All agents understand Open-AIOS story lifecycle (DRAFT → PLANNING → READY_FOR_DEV → IN_PROGRESS → READY_FOR_REVIEW → APPROVED → COMPLETED)
...
| Type           | Open-AIOS       | AIOS Ref   | OMOC Alias      | Purpose                           | Mode     |
| -------------- | --------------- | ---------- | --------------- | --------------------------------- | -------- |
...
| OMOC Agent        | AIOS Reference    | Open-AIOS Agent   | Strategy     | Status       |
| ----------------- | ----------------- | ----------------- | ------------ | ------------ |
...
| Open-AIOS   | AIOS Reference | Purpose                            | Status |
| ----------- | -------------- | ---------------------------------- | ------ |
...
- **Adapt**: Port OMOC agent to Open-AIOS with methodology infusion
...
- Create new agent files with canonical Open-AIOS names
...
- All OMOC agents have canonical Open-AIOS counterparts per ADR-0001
...
> This section defines the executable rules for story-driven development within Open-AIOS. It bridges OMOC's execution speed with AIOS's traceability requirements.
...
| OMOC Pattern           | Open-AIOS Equivalent         | Notes                         |
| ---------------------- | ---------------------------- | ----------------------------- |
...
- Open-AIOS: Story is canonical; mutations require escalation to planning agents
...
- `docs/architecture/open-aios-architecture.md` - Agent hierarchy diagram
