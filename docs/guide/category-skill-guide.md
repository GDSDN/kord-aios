...
This document provides a comprehensive guide to the **Category** and **Skill** systems, which form the extensibility core of Kord AIOS.
...
### Dev-Junior (Delegated Executor)

When you use a Category, a special agent called **Dev-Junior** performs the work.
...
## 6. Configuration Guide (kord-aios.json)

You can fine-tune categories in `kord-aios.json`.
