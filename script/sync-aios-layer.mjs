...
const SRC_ROOT = process.env.AIOS_SRC || "D:/dev/aios-core";
const DEST_ROOT = process.env.OPEN_AIOS_DEST || "D:/dev/open-aios/layer/aios";
...
async function main() {
  console.log(`[sync-aios-layer] source=${SRC_ROOT}`);
  console.log(`[sync-aios-layer] dest=${DEST_ROOT}`);
  ...
  console.log("[sync-aios-layer] done");
}
